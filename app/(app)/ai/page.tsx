...
//       role: "assistant",
//       content:
//         "Hi! I'm Parth AI, powered by Gemini. Ask me anything — code, ideas, explanations, creative tasks, or just chat.",
//     },
//   ]);
...
//   const chat = useRef(geminiModel.startChat());
...
//         role: "assistant",
//         content:
//           "Chat cleared. Hi again! How can I help you today?",
//       },
//     ]);
//     chat.current = geminiModel.startChat();
//   };
...
//             </div>
//             <div>
//               <h1 className="text-3xl font-bold tracking-tight">Parth AI</h1>
//               <p className="text-sm text-muted-foreground flex items-center gap-1.5">
//                 <span className="inline-block h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
//                 Powered by Gemini • Real-time
//               </p>
//             </div>
//           </div>
...
//                 {/* Message Bubble */}
//                 <Card
//                   className={`relative px-6 py-5 shadow-sm transition-all duration-200 ${
//                     message.role === "user"
//                       ? "bg-primary text-primary-foreground rounded-3xl rounded-tr-none"
//                       : "bg-card border rounded-3xl rounded-tl-none"
//                   }`}
//                 >
//                   <div className="flex items-center justify-between mb-3">
//                     <span className="text-xs font-medium opacity-70">
//                       {message.role === "user" ? "You" : "Parth AI"}
//                     </span>
...
//                   </AvatarFallback>
//                 </Avatar>
//                 <Card className="px-6 py-5 rounded-3xl rounded-tl-none bg-card">
...
//               className="min-h-[56px] max-h-[160px] resize-y rounded-3xl py-4 px-6 text-base shadow-sm"
//               onKeyDown={(e) => {
...
//               size="icon"
//               className="h-14 w-14 rounded-3xl shadow-lg bg-primary hover:bg-primary/90 transition-all active:scale-95"
//             >
